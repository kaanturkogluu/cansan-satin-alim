<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('Create Unit') }}</h2>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.units.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="symbol" name="symbol" type="text" class="mt-1 block w-full" :value="old('symbol')" placeholder="örn. adet, kg, L" />
